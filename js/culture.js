// js/culture.js — Культура и туризм
function getDocId(text) {
    ...
    // Новые для culture (из Excel: документ удостоверяющий личность, справка об участии в СВО, удостоверение участника боевых действий, справка удостоверяющая родство, документ подтверждающий родство, удостоверение члена семьи погибшего ветерана боевых действий, документы подтверждающие статус участника СВО или члена семьи)
    if (normalized.includes('документ, удостоверяющий личность посетителя')) return 'visitor_identity_doc';
    if (normalized.includes('справка об участии в сво')) return 'svo_participation';
    if (normalized.includes('удостоверение участника боевых действий')) return 'combat_veteran_cert';
    if (normalized.includes('справка, удостоверяющая родство члена семьи участника сво')) return 'family_kinship_cert';
    if (normalized.includes('документ, подтверждающий родство с участником сво')) return 'kinship_doc';
    if (normalized.includes('удостоверение члена семьи погибшего ветерана боевых действий')) return 'deceased_veteran_family_cert';
    if (normalized.includes('документы, подтверждающие статус участника сво или члена семьи участника сво')) return 'svo_status_docs';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const cultureIcon = document.querySelector('.icon-block[data-id="culture"]');

    // Данные выплат (меры по культуре и туризму из Excel — row 37 и row 60)
    const payouts = [
        {
            title: "Предоставление билетов на культурно-массовые мероприятия участникам СВО и членам их семей государственными театрами подведомственными комитету",
            amount: " ",
            desc: "Заявки на предоставление услуг принимаются при личном обращении в кассу театра. Участники СВО и члены их семей.",
            checklist: [
                "документ, удостоверяющий личность посетителя",
                "справка об участии в СВО и (или) удостоверение участника боевых действий",
                "для членов семьи участника СВО: справка, удостоверяющая родство члена семьи участника СВО",
                "документ, подтверждающий родство с участником СВО (свидетельство о браке, свидетельство о рождении, документ, подтверждающий усыновление, опеку, свидетельство об усыновлении, акт органа опеки об опекунстве)",
                "удостоверение члена семьи погибшего ветерана боевых действий"
            ],
            link: "-",
            linkText: "В театр",
            mfcLink: "-",
        ...
        {
            title: "Льготное посещение государственных музеев Ленинградской области",
            amount: " ",
            desc: "Льготное (бесплатное) посещение государственных музеев, подведомственных комитету по сохранению культурного наследия Ленинградской области, на постоянной основе. В соответствии с Порядком бесплатного посещения музеев лицами, которые участвуют или участвовали в проведении специальной военной операции... Мера поддержки оказывается в беззаявительном порядке при посещении государственного музея Ленинградской области.",
            checklist: [
                "Документы, подтверждающие статус участника СВО или члена семьи участника СВО"
            ],
            link: "-",
            linkText: "В музей",
            mfcLink: "-",
            mfcText: "Беззаявительно"
        }
    ];
    ...
    function renderPayouts() {
        let html = `
            <div class="container payouts-list position-relative py-5">
                ${getBackArrow()}
                <h2 class="text-center mb-5 fw-bold text-primary">Культура и туризм</h2>
    ...
    window.showChecklist = function (index) {
        ...
        const checklistId = `checklist-culture-${index}`;
    ...
    function addCheckboxListeners() {
        document.querySelectorAll('.checklist-cb').forEach(cb => {
            cb.addEventListener('change', function () {
                ...
                const key = `checklist-culture-${payoutIdx}`;
    ...
    // Клик по иконке
    if (cultureIcon) {
        cultureIcon.addEventListener('click', () => {
            renderPayouts();
